...
def create_summary_7():
    ...
    field_note_3 = [const.SUMMARY_FIELD_NOTES_STRUCTURE(1, "吃饭顺序",
                                                        ["蒸 = 煮 < 炖 < 炒 < 煎 < 炸",
                                                         "海鲜 = 牛 < 鸡 < 羊 < 猪",
                                                         "火锅：清汤锅优先，蔬菜优先，不沾酱或者选择酱油，醋等低热量酱料",
                                                         "尽量选择清淡少油的蒸煮类食物，炒已经是底线了",
                                                         "饺子、包子、馄饨：整理卡路里大于米饭，优点是不用配菜",
                                                         "瘦牛肉 + 去皮鸡肉首选，富含蛋白质",
                                                         "海产品：鱼、贝类、虾蟹，卡路里极低，高蛋白是猪肉的几倍，十分推荐",
                                                         ]),
