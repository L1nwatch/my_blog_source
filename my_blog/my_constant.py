...
const.TOOLHUB_CAESAR_CIPHER_URL = const.TOOLHUB_HOME_URL + "caesar_cipher/"
const.TOOLHUB_CAESAR_CIPHER_DATA_URL = const.TOOLHUB_CAESAR_CIPHER_URL + "data"
const.TOOLHUB_CAESAR_CIPHER_ENCRYPT_DATA_URL = const.TOOLHUB_CAESAR_CIPHER_URL + "encrypt_data"
