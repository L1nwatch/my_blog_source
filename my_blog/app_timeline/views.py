...
def travel_event_timeline(request):
    ...
    events.append(const.TRAVEL_EVENT_STRUCTURE("22", "Sept", "公司到汕头", ["6.23 左右从公司出发，到深圳北18.46左右，等车等到19.06出发，坐19.21的高铁回潮汕，d2336","到达潮汕站21.21分，北出口，21.49大巴发车，到达明珠广场 22.36分左右，走到家是22.55分，每隔15分钟有辆大巴，末班车是22.05"]))
